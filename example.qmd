...
var f = board.create('functiongraph',['x^2']);
var p1 = board.create('point',[1, 1], {name:'\\(A^2\\)', usemathjax: true});
var p2 = board.create('point',[1, 2], {name:'\\(A\\)', usemathjax: true});
var p3 = board.create('point',[1, 3], {name:'\\(A_{max}\\)', usemathjax: true});
